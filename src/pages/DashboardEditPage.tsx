...
export default function DashboardEditPage() {
  ...
  const isAdmin = authState.user?.realm_access?.roles?.includes("admin") || import.meta.env.VITE_DEV_MODE === "true"
  console.log("[DashboardEditPage] isAdmin:", isAdmin)

  const offlineMode = import.meta.env.VITE_DEV_MODE === "true"
  ...
  }, [authState.isAuthenticated, offlineMode, navigate])
  ...
  if (!dashboard) {
    ...
    return (
      <div className="flex flex-col items-center justify-center h-screen">
        ...
        <Button onClick={() => navigate("/analytics-hub")}>Back to Analytics Hub</Button>
      </div>
    )
  }
